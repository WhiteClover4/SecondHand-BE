...
router.post('/product/preview', imageUpload.array('product_pictures'), userChecking, productController.createPreviewProduct);
router.post('/product/publish', imageUpload.array('product_pictures'), userChecking, productController.createPublishProduct);
